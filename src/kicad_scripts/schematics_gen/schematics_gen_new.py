...
class ComponentMatrixMaker:
    ...
    def create_component_matrices(
        ...
        """
        This will create a unique component matrix with the given size
        ...
        This will also create and populate a csv file with the component references in the right order
        To be used by PCB generator
    ...
    def __create_component_matrix(
        ...
        output_file = open("../test_project/coils_layout.csv", "w")
        ...
        for row in range(size[0]):
            ...
            for col in range(size[1]):
                ...
                output_file.write(f"{new_component.property.Reference.value},")
            output_file.write("\n")
